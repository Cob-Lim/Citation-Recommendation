...
def main(num_of_chunks, num_of_overlaps, num_of_docs):
    ...
    # Evaluate Reranker
    eval_csv_path = "/home/ubuntu/[March 24, 2025] Final Dataset/sampled_final_cleaned_acl_global_context_dataset_eval.csv" # Update with your actual file path
    ...
    for i, query in enumerate(queries, start=1):
        ...
        citation_items, chunks = retrieve_from_chroma(loaded_collection, query_embedding, number_of_docs=number_of_docs)
    ...
    chunks_file_path = "/home/ubuntu/RAG Pipeline/March 24 Chunks"
    ...
    citations_file_path = "/home/ubuntu/RAG Pipeline/March 24 Citations"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Infly-ChromaDB-Bread (ICB) retrieval.")
